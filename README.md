...
class ShahariaHossain:
  ...
  solve  = ["Codeforces", "HackerRank", "LeetCode"]
  status = "Available for Full-time · Remote · Research"
```

🏗️ I design **systems**, not just features &nbsp;|&nbsp; 🧠 AI + Full Stack — rare combo  
🔬 Thesis: Bangla Hate Speech Detection (Electra) &nbsp;|&nbsp; 🚀 Shipping real-world software
...
```
⚔️ Codeforces  →  Active solver (C / C++)   |   🟩 HackerRank  →  Algorithm practice
🟡 LeetCode    →  Data structures & logic    |   📘 C / C++ / Java  →  System foundations
```
...
```
✦ Complete SYSTEM designer — architecture first, code second
✦ AI + Full Stack in one package — rare & high-value skill set  
✦ SOLID · Clean Code · Repository Pattern · DRY — every project
✦ Thesis-grade NLP research on real Bangla language problems
✦ Competitive programmer — algorithms are second nature
✦ Ships working software, not just demos
```
...
| 🏗️ | Advanced system design & microservice patterns |
| 🔬 | Expanding Bangla AI research toward publication |
| 🌍 | Targeting top-tier roles & Europe MSc scholarships |
...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0d47a1,100:000000&height=100&section=footer&text=Let%27s%20Build%20Something%20Extraordinary&fontSize=15&fontColor=00b4ff&fontAlignY=65&animation=fadeIn" />
